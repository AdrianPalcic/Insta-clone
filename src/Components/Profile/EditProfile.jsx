                ...
                {/*  
                    ...
                    BITNO!!!!
             Ovo je UI stranica na kojoj osoba unesuje inpute koje zeli promjeniti
             sa cooresponding pozivima na odredene funkcije za promjenu       
							...
							<Stack spacing={4} w={"full"} maxW={"md"} bg={"black"} p={6} my={0}>
								...
								<FormControl>
									<Stack direction={["column", "row"]} spacing={6}>
                                        ...
                                        {/* Referencirat cemo ga preko gumba iznad */}
